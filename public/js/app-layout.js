...
(function () {
  ...
  document.addEventListener('livewire:init', function () {
    ...
    Livewire.on('show-modal', function (params) {
      var _ref, _ref2;
      var modalId = ((_ref = Array.isArray(params) ? params[0] : params) === null || _ref === void 0 ? void 0 : _ref.id) || ((_ref2 = Array.isArray(params) ? params[0] : params) === null || _ref2 === void 0 ? void 0 : _ref2.modal) || (typeof params === 'string' ? params : null);
      if (modalId) {
    ...
    Livewire.on('hide-modal', function (params) {
      var _ref3;
      var modalId = ((_ref3 = Array.isArray(params) ? params[0] : params) === null || _ref3 === void 0 ? void 0 : _ref3.id) || (typeof params === 'string' ? params : null);
      if (modalId) {
        var id = modalId.replace(/^#/, '');
        $('#' + id).modal('hide');
      }
  ...
  document.addEventListener('click', function (e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Livewire.dispatch(data.swalMethod, {
          id: data.swalId
        });
      }
    });
