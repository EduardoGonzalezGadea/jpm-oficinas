...
return new class extends Migration
{
    ...
    private function fixTesMultasCobradas(): void
    {
        ...
        // Eliminar ndices de forma segura usando DB::statement ya que Schema::table no captura errores de ejecucin en closures
        try { DB::statement('ALTER TABLE tes_multas_cobradas DROP INDEX tes_multas_cobradas_recibo_serie_recibo_numero_unique'); } catch (\Exception $e) {}
        try { DB::statement('ALTER TABLE tes_multas_cobradas DROP INDEX tes_multas_cobradas_recibo_fecha_index'); } catch (\Exception $e) {}
        try { DB::statement('ALTER TABLE tes_multas_cobradas DROP INDEX tes_multas_cobradas_planilla_id_index'); } catch (\Exception $e) {}
