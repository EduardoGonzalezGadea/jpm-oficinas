...
@section('title', 'Tesorería | Oficinas - Mi Perfil')
                            ...
                            <div class="mt-4">
                                <form action="{{ route('usuarios.actualizarPerfil') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="direccion" name="direccion" class="form-control @error('direccion') is-invalid @enderror" rows="3"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ ucfirst($usuario->getRoleNames()->first() ?? 'Sin rol') }}" readonly>
                                ...
                                <form action="{{ route('usuarios.cambiarContraseña') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="contraseña_actual" name="contraseña_actual"
                                            class="form-control @error('contraseña_actual') is-invalid @enderror" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="nueva_contraseña_confirmation"
                                            name="nueva_contraseña_confirmation" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <button type="button" class="btn btn-secondary ml-2"
                                            onclick="limpiarFormularioContrasena()">
