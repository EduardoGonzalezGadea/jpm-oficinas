<div>
  ...
  <!-- Modal Crear/Editar -->
  @if($showModal)
  <div wire:ignore.self class="modal fade" id="modalTipoLibreta" tabindex="-1" role="dialog">
  ...
  <!-- Modal Borrar -->
  @if($showDeleteModal)
  <div wire:ignore.self class="modal fade" id="modalBorrarTipoLibreta" tabindex="-1" role="dialog">
