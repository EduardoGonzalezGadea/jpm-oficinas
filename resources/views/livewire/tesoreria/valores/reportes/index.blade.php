<div class="container-fluid">
    <style>
        ...
        #stock-valores-print table {
            ...
            /* Asegurar que no fuerce salto antes */
        ...
        <div class="col-12">
            <div class="card shadow-sm mb-3 d-print-none">
                <div class="card-header bg-info text-white py-2 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-chart-pie mr-2"></i>Reporte de Stock de Valores</h5>
                    <a href="{{ route('tesoreria.valores.index') }}" class="btn btn-sm btn-light text-dark font-weight-bold">
    ...
    <script>
        function descargarPDFStock() {
            ...
            const opt = {
                ...
                /* Modo mixto para mejor compatibilidad */
