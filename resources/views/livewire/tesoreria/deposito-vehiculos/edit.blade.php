          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="titular" class="form-control" id="edit_titular">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="cedula" class="form-control" id="edit_cedula">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="telefono" class="form-control" id="edit_telefono">
