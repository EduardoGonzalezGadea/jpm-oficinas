      ...
      <form wire:submit="guardar">
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" wire:model.live="valor" class="form-control" step="0.01"
                  min="0.01">
              </div>
              @error('valor')
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label>Orden</label>
              <input type="number" wire:model.live="orden" class="form-control" min="0">
              @error('orden')
                <span class="text-danger">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="custom-control custom-switch">
                <input type="checkbox" wire:model.live="activo" class="custom-control-input"
                  id="activoSwitch">
