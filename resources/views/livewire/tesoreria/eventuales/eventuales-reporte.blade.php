        ...
        <div class="col-md-12">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-info text-white py-2 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-print mr-2"></i>Reporte Avanzado de Eventuales</h5>
                    <a href="{{ route('tesoreria.eventuales.index') }}" class="btn btn-sm btn-light text-dark font-weight-bold">
                ...
                <div class="card-body py-2">
                    <form wire:submit.prevent="buscar">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="card mb-2">
                                    <div class="card-header bg-light py-1 px-2 border-bottom-0"><strong><small>Datos del Trámite / Institución</small></strong></div>
                                    <div class="card-body py-1 px-2">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-2">
                    ...
                    <table class="table table-sm table-striped table-hover mb-0" style="font-size: 0.85rem;">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="sticky-top">Institución</th>
                                <th class="sticky-top">Titular</th>
                                <th class="sticky-top">Recibo / Ingreso</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->titular }}</td>
                                <td class="text-nowrap">{{ $row->ingreso }}</td>
