<div id="print-container" style="background: white; padding: 20px;">
    ...
    <table class="table table-bordered table-sm table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td class="text-nowrap">{{ $eventual->fecha->format('d/m/Y') }}</td>
                <td class="text-right text-nowrap">{{ $eventual->ingreso }}</td>
                <td>{{ $eventual->institucion }}</td>
                <td>{{ $eventual->titular }}</td>
                <td class="text-nowrap">{{ $eventual->recibo }}</td>
                <td class="text-nowrap">{{ $eventual->orden_cobro }}</td>
                <td class="text-right text-nowrap">{{ $eventual->monto_formateado }}</td>
            </tr>
            @empty
            <tr>
