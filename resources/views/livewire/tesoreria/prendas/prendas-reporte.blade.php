        ...
        <div class="col-md-12">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-dark text-white py-2 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-file-invoice-dollar mr-2"></i>Reporte Avanzado de Gestión de Prendas</h5>
                    <a href="{{ route('tesoreria.prendas.index') }}" class="btn btn-sm btn-light text-dark font-weight-bold">
                ...
                <div class="card-body py-2">
                    <form wire:submit.prevent="buscar">
                        <div class="row">
                            ...
                            <!-- Grupo 2: Datos del Titular y Documentación (Ancho Total) -->
                            <div class="col-md-12">
                                <div class="card mb-2">
                                    <div class="card-header bg-light py-1 px-2 border-bottom-0">
                                    ...
                                    <div class="card-body py-2 px-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 border-right">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-8 mb-2">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Nombre completo del titular" wire:model.defer="filters.titular_nombre">
                                                    </div>
                                                    <div class="col-md-4 mb-2">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Cédula / Documento" wire:model.defer="filters.titular_cedula">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Concepto y Medio de Pago -->
                                            <div class="col-md-12 mt-2 pt-2 border-top">
                                                <div class="form-row">
                                                    <div class="col-md-9 mb-1">
                                                        <label class="mb-0 small font-weight-bold">Concepto / Detalle de la Prenda</label>
                                                        <input type="text" class="form-control form-control-sm" placeholder="Buscar por concepto o detalle..." wire:model.defer="filters.concepto">
                                                    </div>
                                                    <div class="col-md-3 mb-1">
                                                        <label class="mb-0 small font-weight-bold">Medio de Pago</label>
                    ...
                    <table class="table table-sm table-striped table-hover mb-0" style="font-size: 0.85rem;">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="sticky-top">Nro. Recibo</th>
                                <th class="sticky-top">Titular</th>
                                <th class="sticky-top">C.I. / Doc.</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small>{{ $row->medioPago ? $row->medioPago->nombre : 'N/A' }}</small></td>
                        ...
                        <tfoot class="bg-light">
                            <tr>
                                <td colspan="6" class="text-right font-weight-bold p-2">TOTAL:</td>
                                <td class="text-right font-weight-bold text-nowrap p-2" style="font-size: 1rem; border-left: 1px solid #dee2e6;">$ {{ number_format($resultados->sum('monto'), 2, ',', '.') }}</td>
                                <td></td>
                            </tr>
                        </tfoot>
                        @endif
