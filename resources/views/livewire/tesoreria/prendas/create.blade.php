          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="titular_cedula" class="form-control" id="titular_cedula">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="titular_telefono" class="form-control" id="titular_telefono">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model.blur="transferencia" class="form-control" id="transferencia">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="date" wire:model="transferencia_fecha" class="form-control" id="transferencia_fecha">
