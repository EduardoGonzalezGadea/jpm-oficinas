          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="recibo_serie" class="form-control" id="edit_recibo_serie">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="recibo_numero" class="form-control" id="edit_recibo_numero">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="date" wire:model="recibo_fecha" class="form-control" id="edit_recibo_fecha">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" wire:model="orden_cobro" class="form-control" id="edit_orden_cobro">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" wire:model="concepto" class="form-control" id="edit_concepto">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="titular_cedula" class="form-control" id="edit_titular_cedula">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model="titular_telefono" class="form-control" id="edit_titular_telefono">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" step="0.01" wire:model="monto" class="form-control" id="edit_monto">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select wire:model="medio_pago_id" class="form-control" id="edit_medio_pago_id">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" wire:model.blur="transferencia" class="form-control" id="edit_transferencia">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="date" wire:model="transferencia_fecha" class="form-control" id="edit_transferencia_fecha">
...
@push('scripts')
<script>
  window.addEventListener('swal:confirm-duplicate-edit', function(event) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Livewire.dispatch('confirmUpdate');
      }
    });
  });
