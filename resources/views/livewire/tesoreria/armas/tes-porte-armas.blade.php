<div>
  ...
  <div wire:ignore.self class="modal fade" id="porteFormModal"
       tabindex="-1" role="dialog" aria-labelledby="porteFormModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="porteFormModalLabel">
  ...
  <div wire:ignore.self class="modal fade" id="porteDeleteModal"
  ...
  <!-- Modal de Detalle -->
  <div wire:ignore.self class="modal fade" id="porteDetailModal"
       tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <script>
    ...
    $(document).ready(function () {
      $('#porteFormModal').on('hidden.bs.modal', function () {
        Livewire.dispatch('resetForm');
      });
      $('#porteDeleteModal').on('hidden.bs.modal', function () {
        Livewire.dispatch('closeDeleteModal');
      });
      $('#porteDetailModal').on('hidden.bs.modal', function () {
