<div>
    <div class="card">
        <div class="card-header bg-primary text-white py-2 px-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('tesoreria.armas.porte.planillas.imprimir', $planilla->id) }}" target="_blank" class="btn btn-light btn-sm mr-2">
                    <i class="fas fa-print"></i> Imprimir
                </a>
                <a href="{{ route('tesoreria.armas.porte.planillas.index') }}" class="btn btn-light btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex justify-content-between align-items-end border-bottom pb-2">
                    <h2 class="mb-0">Planilla de Porte de Armas</h2>
