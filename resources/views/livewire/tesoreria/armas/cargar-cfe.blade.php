  ...
  <div class="card border-success shadow-sm">
    ...
    <div class="card-body p-2">
      ...
      <div class="mt-2 pt-1 border-top small">
        <div class="mb-1"><i class="fas fa-tag mr-1 text-muted"></i><strong>Detalle:</strong> <span class="text-muted">{{ $datosExtraidos['detalle'] }}</span></div>
        @if(!empty($datosExtraidos['descripcion']))
        <div class="mb-0"><i class="fas fa-comment mr-1 text-muted"></i><strong>Descripción:</strong> <span class="text-muted">{{ $datosExtraidos['descripcion'] }}</span></div>
        @endif
      </div>
    </div>
