        ...
        <div class="col-md-12">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-info text-white py-2 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-print mr-2"></i>Reporte Avanzado de Porte de Armas</h5>
                    <a href="{{ route('tesoreria.armas.porte') }}" class="btn btn-sm btn-light text-dark font-weight-bold">
