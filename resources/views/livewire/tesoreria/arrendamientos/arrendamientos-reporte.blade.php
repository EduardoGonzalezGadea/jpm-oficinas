        ...
        <div class="col-md-12">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-info text-white py-2 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-print mr-2"></i>Reporte Avanzado de Arrendamientos</h5>
                    <a href="{{ route('tesoreria.arrendamientos.index') }}" class="btn btn-sm btn-light text-dark font-weight-bold">
                ...
                <div class="card-body py-2">
                    <form wire:submit.prevent="buscar">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="card mb-2">
                                    <div class="card-header bg-light py-1 px-2 border-bottom-0"><strong><small>Datos del Trámite</small></strong></div>
                                    <div class="card-body py-1 px-2">
                                        <div class="form-row">
                                            <div class="col-md-8 mb-2">
                                                <label class="mb-0 small" for="nombre">Nombre / Titular</label>
                                                <input type="text" id="nombre" class="form-control form-control-sm" wire:model.defer="filters.nombre" placeholder="Nombre completo o parcial">
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-2">
                                                <label class="mb-0 small" for="recibo">Nro. Recibo / OC</label>
