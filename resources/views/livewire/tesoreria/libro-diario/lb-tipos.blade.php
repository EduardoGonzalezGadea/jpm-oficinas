<div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-section card-header-gradient py-2 px-3 d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><strong><i class="fas fa-tag mr-2"></i>Tipos de Asiento</strong></h4>
          <div class="btn-group">
            ...
            <table class="table table-bordered table-sm">
              <thead>
                <tr>
                  ...
                  <th class="text-center align-middle">Signo</th>
                ...
                @forelse ($items as $item)
                  <tr>
                    ...
                    <td class="text-center align-middle">
                      @if($item->signo == 1)
                        <span class="badge badge-success">+1 (Entrada)</span>
                      @elseif($item->signo == -1)
                        <span class="badge badge-danger">-1 (Salida)</span>
                      @else
                        <span class="badge badge-secondary">0 (Redistribución)</span>
                      @endif
                    </td>
                    <td class="text-center align-middle">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">{{ $item_id ? 'Editar' : 'Crear' }} Tipo</h5>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group">
              ...
              @error('signo') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
          </form>
        </div>
  ...
  <div wire:ignore.self class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Detalles del Tipo</h5>
        ...
        <div class="modal-body">
          @if ($selectedItem)
            ...
            <p class="mb-0"><strong>Signo:</strong> {{ $selectedItem->signo }}</p>
