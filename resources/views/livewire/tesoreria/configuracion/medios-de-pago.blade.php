          ...
          <form>
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('nombre_corto') is-invalid @enderror"
                  wire:model.defer="nombre_corto" id="nombre_corto" placeholder="Ej: TRANSFERENCIA">
                @error('nombre_corto')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('descripcion') is-invalid @enderror"
                wire:model.defer="descripcion" id="descripcion" rows="2"></textarea>
              @error('descripcion')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control @error('orden') is-invalid @enderror"
                  wire:model.defer="orden" id="orden" min="0">
                @error('orden')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('codigo_soniar') is-invalid @enderror"
                  wire:model.defer="codigo_soniar" id="codigo_soniar" placeholder="Opcional">
                @error('codigo_soniar')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <div class="custom-control custom-switch">
                  <input type="checkbox" class="custom-control-input" wire:model.defer="es_libro_diario"
              ...
              <div class="form-group col-md-4">
                <div class="custom-control custom-switch">
                  <input type="checkbox" class="custom-control-input" wire:model.defer="es_recaudacion"
            ...
            <div class="form-group">
              <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input" wire:model.defer="contado"
                  id="contado" value="1">
