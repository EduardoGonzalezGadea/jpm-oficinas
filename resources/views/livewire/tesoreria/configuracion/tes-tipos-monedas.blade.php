<div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-section card-header-gradient py-2 px-3 d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><strong><i class="fas fa-coins mr-2"></i>Tipos de Monedas</strong></h4>
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('descripcion') is-invalid @enderror"
                wire:model="descripcion" id="descripcion" rows="3"></textarea>
              @error('descripcion')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
  ...
  @push('scripts')
    <script>
      ...
      Livewire.on('tipoMonedaStore', () => {
        $('#tipoMonedaModal').modal('hide');
      });

      Livewire.on('tipoMonedaUpdate', () => {
        $('#tipoMonedaModal').modal('hide');
      });
      });
