<div>
      ...
      <div class="row mb-4">
        <div class="col-md-5">
          <div class="input-group">
            ...
            <input type="text" class="form-control border-left-0" placeholder="Buscar por nombre o código..." wire:model.live.debounce.300ms="search">
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group mb-4">
                  ...
                  <input type="text" class="form-control form-control-lg border shadow-sm @error('nombre') is-invalid @enderror" wire:model="nombre" placeholder="Ej: RECAUDACIÓN DIARIA 222 JPM">
              ...
              <div class="col-md-4">
                <div class="form-group mb-4">
                  ...
                  <input type="text" class="form-control form-control-lg text-uppercase font-weight-bold border shadow-sm @error('codigo') is-invalid @enderror" wire:model="codigo" placeholder="Ej: ER-222-JPM">
            ...
            <div class="row border rounded p-3 bg-white mb-4 mx-0 shadow-sm">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control" wire:model.live="tipo_recaudacion">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control shadow-sm" wire:model="institucion_222_id">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control shadow-sm text-uppercase" wire:model="turno">
                ...
                <div class="col-md-6 mb-2">
                  <div class="custom-control custom-checkbox p-2 border rounded-pill hover-bg-light transition-all px-4">
                    <input type="checkbox" class="custom-control-input" id="conc_{{ $concepto->id }}"
                      value="{{ $concepto->id }}" wire:model="conceptos_seleccionados">
            ...
            <div class="row align-items-center">
              <div class="col-md-4">
                <div class="form-group mb-0">
                  ...
                  <input type="number" class="form-control border shadow-sm" wire:model="orden">
                </div>
              </div>
  ...
  <script>
    ...
    window.addEventListener('closeModal', event => {
      $('#' + window.LiveEvent(event).id).modal('hide');
    });
  </script>
</div>