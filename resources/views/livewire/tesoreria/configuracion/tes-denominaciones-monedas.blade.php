<div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-section card-header-gradient py-2 px-3 d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><strong><i class="fas fa-dollar-sign mr-2"></i>Denominaciones de Moneda</strong></h4>
          ...
          <form>
            <div class="form-group">
              ...
              <select class="form-control @error('tipo_moneda') is-invalid @enderror"
                wire:model="tipo_moneda" id="tipo_moneda" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" step="0.01" min="0" max="999999.99"
                  ...
                  wire:model="denominacion" id="denominacion"
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('descripcion') is-invalid @enderror"
                wire:model="descripcion" id="descripcion" rows="3"
  ...
  @push('scripts')
    <script>
      ...
      Livewire.on('denominacionStore', () => {
        $('#denominacionModal').modal('hide');
      });

      Livewire.on('denominacionUpdate', () => {
        $('#denominacionModal').modal('hide');
      });
      });
