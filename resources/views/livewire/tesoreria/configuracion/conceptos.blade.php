      ...
      <div class="row mb-3">
        <div class="col-md-4">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Buscar concepto o código SIIF..." wire:model.live="search">
          </div>
        </div>
      </div>
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                wire:model="nombre" placeholder="Nombre completo del concepto">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" wire:model="codigo_siif" placeholder="Opcional">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row mt-2">
              <div class="col-md-6">
                <div class="custom-control custom-switch">
                  <input type="checkbox" class="custom-control-input" id="swRequiereInst" wire:model="requiere_institucion">
                  <label class="custom-control-label font-weight-bold" for="swRequiereInst">¿Requiere institución (Art. 222)?</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="custom-control custom-switch">
                  <input type="checkbox" class="custom-control-input" id="swActivo" wire:model="activo">
