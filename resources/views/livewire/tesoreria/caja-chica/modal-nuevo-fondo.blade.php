            ...
            <div class="modal-content">
                <form wire:submit.prevent="guardar">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-warning" wire:loading.attr="disabled" wire:target="guardar">
                            <span wire:loading.class="d-none" wire:target="guardar">Guardar Fondo</span>
