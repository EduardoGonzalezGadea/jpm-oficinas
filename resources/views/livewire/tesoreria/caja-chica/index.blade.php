<div>
        ...
        <div class="form-row mb-3">
            ...
            <div class="col-md-7 align-self-end d-print-none">
                <div class="btn-group d-flex" role="group">
                    <button class="btn btn-info flex-fill" wire:click="abrirGestionDependencias">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            ...
                            <button type="button" class="close" wire:click="closeRecuperarModal"
                                aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <tbody>
                @forelse ($tablaPendientesDetalle as $item)
                    <tr wire:key="pendiente-{{ $item->idPendientes }}">
                        ...
                        <td
                            class="text-right align-middle {{ ($item->saldo ?? 0) > 0 ? 'text-warning font-weight-bold' : '' }}">
                        ...
                        <td class="text-center align-middle d-print-none">
                            ...
                            <div class='btn-group' role='group'>
                                <button type="button" class="btn btn-sm btn-dark mr-1"
                                    wire:click="$emit('mostrarModalEditarPago', {{ $item->idPagos }})"
                                    title="Editar">
                                    <i class="fas fa-pencil-alt"></i>
                                </button>
    ...
    @endif {{-- Cierre del @else de $mostrarGestionDependencias --}}
</div>
