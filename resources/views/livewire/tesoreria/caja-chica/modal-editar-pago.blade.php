                ...
                <div class="modal-body">
                    <form wire:submit.prevent="actualizarPago">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="actualizarPago">
                                <span wire:loading.class="d-none" wire:target="actualizarPago">Guardar</span>
                                <span wire:loading.class.remove="d-none" wire:target="actualizarPago"
