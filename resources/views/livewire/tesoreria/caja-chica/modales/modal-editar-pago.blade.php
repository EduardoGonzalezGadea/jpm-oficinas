                ...
                <div class="modal-body pt-2 pb-3 bg-white">
                    <form wire:submit.prevent="actualizarPago">
                            ...
                            <div class="form-row px-2">
                                ...
                                <div class="form-group col-md-4 mb-2">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number" class="form-control form-control-sm font-weight-bold @error('pago.montoPagos') is-invalid @enderror" step="0.01" wire:model="pago.montoPagos">
                                    </div>
                        ...
                        <fieldset class="border p-2 mb-1 rounded position-relative shadow-sm" style="background-color: #fcfcfc; border-color: #e9ecef !important;">
                            ...
                            <div class="form-row px-2">
                                <div class="form-group col-md-4 mb-1">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <div class="input-group-prepend"><span class="input-group-text bg-white">$</span></div>
                                        <input type="number" class="form-control form-control-sm text-info font-weight-bold @error('pago.recuperadoPagos') is-invalid @enderror" step="0.01" wire:model.defer="pago.recuperadoPagos" placeholder="0.00">
                                    </div>
                        ...
                        <div class="d-flex justify-content-end mt-3 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm px-4 shadow-sm" wire:loading.attr="disabled" wire:target="actualizarPago">
