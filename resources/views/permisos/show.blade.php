            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" onclick="deletePermission({{ $permission->id }})">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="mb-0">
                                        ...
                                        <span class="badge bg-secondary ms-2">{{ $rolesWithPermission->count() }}</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                                            ...
                                                            @if($role->users->count() > 0)
                                                                <div class="mt-2">
                                                                    ...
                                                                    @if($role->users->count() > 3)
                                                                        <span class="badge bg-light text-dark">+{{ $role->users->count() - 3 }} más</span>
                                                                    @endif
                                                                </div>
                                                            @endif
                                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            ...
                                            <span class="badge bg-warning text-dark ms-2">{{ $usersWithDirectPermission->count() }}</span>
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            ...
                                            <span class="badge bg-success ms-2">{{ $usersWithRolePermission->count() }}</span>
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        @if($usersWithRolePermission->count() > 0)
                                            <div class="row">
                                                ...
                                                @if($usersWithRolePermission->count() > 12)
                                                    <div class="col-12 mt-2">
                                                        <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#allUsers">
                                                            Ver todos los {{ $usersWithRolePermission->count() }} usuarios
                                                        </button>
            ...
            <div class="modal-body">
                ...
                @if($rolesWithPermission->count() > 0 || $usersWithDirectPermission->count() > 0)
                    <div class="alert alert-danger">
                        <strong>Advertencia:</strong> Este permiso está actualmente asignado a {{ $rolesWithPermission->count() }} rol(es) y {{ $usersWithDirectPermission->count() }} usuario(s) directamente.
                    </div>
                @endif
            </div>
