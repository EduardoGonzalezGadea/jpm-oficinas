                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="index" id="action_index"
                                    name="actions[]">
                                <label class="form-check-label" for="action_index">index (ver listado)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="create" id="action_create"
                                    name="actions[]">
                                <label class="form-check-label" for="action_create">create (crear)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="edit" id="action_edit"
                                    name="actions[]">
                                <label class="form-check-label" for="action_edit">edit (editar)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="show" id="action_show"
                                    name="actions[]">
                                <label class="form-check-label" for="action_show">show (ver detalle)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="destroy" id="action_destroy"
                                    name="actions[]">
