...
@section('titulo', 'Detalle del Rol - JPM Oficinas')
                                ...
                                <div class="card-body">
                                                    ...
                                                    <div class="card border-info">
                                                        <div class="card-header bg-light">
                                                            <h6 class="mb-0 text-capitalize">
                                                                ...
                                                                <span class="badge badge-info float-right">{{ $modulePermissions->count() }}</span>
                                                            </h6>
                                                        </div>
                                                        <div class="card-body p-2">
                                                            @foreach($modulePermissions as $permission)
                                                                <span class="badge badge-secondary mb-1 d-block text-left">
                                    ...
                                    @else
                                        <div class="alert alert-warning">
                                            ...
                                            <a href="{{ route('roles.edit', $role) }}" class="alert-link">Asignar permisos</a>
                                        </div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <div class="alert alert-info">
                                            ...
                                            @can('users.edit')
                                                <a href="{{ route('users.index') }}" class="alert-link">Asignar usuarios</a>
                                            @endcan
                                        </div>
                                    @endif
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Está seguro de remover el rol <strong>{{ $role->name }}</strong> del usuario <span id="userName"></span>?</p>
            </div>
