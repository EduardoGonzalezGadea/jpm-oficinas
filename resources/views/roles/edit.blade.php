                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($role->name === 'administrador')
                                            <small class="form-text text-warning">
                                                <i class="fas fa-lock"></i> El nombre del rol administrador no se puede
                                                cambiar
                                            </small>
                                        @else
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body py-2">
                                                <small>
                                                    ...
                                                    {{ $role->created_at->format('d/m/Y H:i') }}<br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            @if ($permissions->count() > 0)
                                                @php
                                                    $permissionsByModule = $permissions->groupBy(function (
                                                        $permission,
                                                    ) {
                                                            ...
                                                            <div class="card-header py-2">
                                                                <h6 class="mb-0 text-capitalize">
                                                                    ...
                                                                    <small class="float-right">
                                                                        @php
                                                                            $moduleSelected = $modulePermissions
                                            ...
                                            @else
                                                <div class="col-12">
                                                    <div class="alert alert-warning">
                                                        ...
                                                        <a href="{{ route('permissions.index') }}" class="alert-link">Crear
                                                            permisos primero</a>.
                                                    </div>
                                                </div>
                                            @endif
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateModuleCounts() {
                    ...
                    modules.forEach(counter => {
                        ...
                        const moduleCheckboxes = moduleCard.querySelectorAll('input[type="checkbox"]');
                        const selectedCount = moduleCard.querySelectorAll('input[type="checkbox"]:checked')
                            .length;
