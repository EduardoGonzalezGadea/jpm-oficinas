                                            ...
                                            @if($role->permissions->count() > 0)
                                                ...
                                                <small class="text-muted">
                                                    @foreach($role->permissions->take(3) as $permission)
                                                        <span class="badge badge-secondary mr-1">{{ $permission->name }}</span>
                                                    @endforeach
                                                    @if($role->permissions->count() > 3)
                                                        <span class="badge badge-light">+{{ $role->permissions->count() - 3 }} más</span>
                                                    @endif
                                                </small>
                                            @endif
                                        </td>
                                        <td>
                                            <span class="badge badge-primary">{{ $role->users->count() }} usuarios</span>
                                        </td>
