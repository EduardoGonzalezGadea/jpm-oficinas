...
class Multa303 extends Component
{
    ...
    public function store()
    {
        ...
        $this->dispatch('swal:success', text: $this->isEdit ? 'Multa (Dec. 303/2023) actualizada exitosamente.' : 'Multa (Dec. 303/2023) creada exitosamente.');
    }
    ...
    public function delete($id)
    {
        ...
        $this->dispatch('swal:success', text: 'Multa (Dec. 303/2023) eliminada exitosamente.');
    }
