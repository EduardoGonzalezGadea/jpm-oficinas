...
class ModalNuevoPago extends Component
{
    ...
    public function abrirModal($idCajaChica)
    {
        ...
        $this->dispatch('show-modal', id: 'modalNuevoPago');
    }
    ...
    public function guardar()
    {
        ...
        try {
            ...
            DB::commit();
            $this->dispatch('swal:success', text: 'Pago Directo creado correctamente.');
            $this->dispatch('hide-modal', id: 'modalNuevoPago');
            $this->dispatch('pagoCreado')->to('tesoreria.caja-chica.index');
        } catch (\Exception $e) {
            DB::rollBack();
            $this->dispatch('swal:toast-error', text: 'Error al crear el pago directo: ' . $e->getMessage());
        }
    }

    public function render()
    {
        return view('livewire.tesoreria.caja-chica.modales.modal-nuevo-pago');
    }
}
