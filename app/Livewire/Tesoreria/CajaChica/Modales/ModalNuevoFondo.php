...
class ModalNuevoFondo extends Component
{
    ...
    public function guardar()
    {
        ...
        if ($existe) {
            ...
            $this->dispatch('swal:toast-error', text: 'Ya existe un Fondo Permanente para este mes y año.');
            return;
        } else {
            ...
            $this->dispatch('swal:success', text: 'Fondo Permanente creado correctamente.');
            $this->cerrarModal();
            // Notificar al componente principal para recargar datos
            $this->dispatch('fondoCreado')->to('tesoreria.caja-chica.index');
        }
    }

    public function render()
    {
        return view('livewire.tesoreria.caja-chica.modales.modal-nuevo-fondo');
    }
}
