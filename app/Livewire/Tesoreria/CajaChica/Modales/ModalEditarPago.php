...
class ModalEditarPago extends Component
{
    ...
    public function actualizarPago()
    {
        ...
        $data = [
            'fechaEgresoPagos' => $this->pago['fechaEgresoPagos'] ? Carbon::parse($this->pago['fechaEgresoPagos']) : Carbon::parse($this->pago['fechaEgresoPagos']),
        ...
        try {
            ...
            $service->actualizarPago($this->idPago, $data);
    ...
    public function eliminarRendicion()
    {
        ...
        try {
            $service = app(\App\Services\Tesoreria\CajaChicaService::class);
            $service->eliminarRendicionPago($this->idPago);
    ...
    public function eliminarRecuperacion()
    {
        ...
        try {
            $service = app(\App\Services\Tesoreria\CajaChicaService::class);
            $service->eliminarRecuperacionPago($this->idPago);
    ...
    public function eliminarBSE()
    {
        ...
        try {
            $service = app(\App\Services\Tesoreria\CajaChicaService::class);
            $service->eliminarBSEPago($this->idPago);
