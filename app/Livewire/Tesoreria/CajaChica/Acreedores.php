...
class Acreedores extends Component
{
    ...
    public function edit($id)
    {
        try {
            ...
            $this->dispatch('swal:error', text: 'Error al cargar el acreedor.');
        }
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            $this->dispatch('swal:error', text: 'Error al guardar el acreedor.');
        }
    }
    ...
    public function delete()
    {
        try {
            ...
            $this->dispatch('swal:error', text: 'Error al eliminar el acreedor.');
        }
    }
