...
class ModalEditarDetalle extends Component
{
    ...
    public function guardarCambios()
    {
        ...
        try {
            ...
            $service->actualizarPendiente($this->idPendiente, [
            ...
            $this->dispatch('pendienteActualizado');
        } catch (\Exception $e) {
            DB::rollBack();
            $this->dispatch('swal:toast-error', text: 'Error al actualizar el pendiente: ' . $e->getMessage());
        }
    }
