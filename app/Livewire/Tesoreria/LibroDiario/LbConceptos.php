...
class LbConceptos extends Component
{
    ...
    public function store()
    {
        ...
        $this->dispatch('alert', ['type' => 'success', 'message' => 'Concepto creado con éxito!', 'toast' => true]);
    }
    ...
    public function update()
    {
        ...
        if ($this->item_id) {
            ...
            $this->dispatch('alert', ['type' => 'success', 'message' => 'Concepto actualizado con éxito!', 'toast' => true]);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $item->delete();
        $this->dispatch('alert', ['type' => 'success', 'message' => 'Concepto eliminado con éxito!', 'toast' => true]);
    }
