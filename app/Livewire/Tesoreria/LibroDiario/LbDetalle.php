...
class LbDetalle extends Component
{
    ...
    public function store()
    {
        ...
        if ($creados > 0) {
            ...
            $this->dispatch('alert', ['type' => 'info', 'message' => 'Todos los registros ya existían. No se creó ninguno nuevo.', 'toast' => true]);
        }
    }
    ...
    public function update()
    {
        ...
        if ($this->item_id) {
            ...
            $this->dispatch('alert', ['type' => 'success', 'message' => 'Detalle actualizado con éxito!', 'toast' => true]);
        }
    }
    ...
    public function destroy($id)
    {
        $item = Model::findOrFail($id);
        $item->delete();
        $this->dispatch('alert', ['type' => 'success', 'message' => 'Detalle eliminado con éxito!', 'toast' => true]);
    }
