...
namespace App\Livewire\Tesoreria\Valores;
...
class Index extends Component
{
    ...
    {
        $this->dispatch('swal:confirm', title: '¿Eliminar Libreta?', text: 'Esta acción no se puede revertir.', method: 'delete', id: $id, componentId: $this->getId());
    }

    public function delete($id)
    {
        LibretaValor::find($id)->delete();
        $this->dispatch('swal:success', text: 'Libreta eliminada correctamente.');
    }
