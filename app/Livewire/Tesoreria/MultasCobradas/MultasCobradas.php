...
namespace App\Livewire\Tesoreria\MultasCobradas;
...
class MultasCobradas extends Component
{
    ...
    public function generarReporte()
    {
        ...
        $this->dispatch('openInNewTab', route('tesoreria.multas-cobradas.imprimir-detalles', [
    ...
    {
        $this->validate(['fechaDesde' => 'required|date', 'fechaHasta' => 'required|date|after_or_equal:fechaDesde']);
        $this->dispatch('openInNewTab', route('tesoreria.multas-cobradas.imprimir-resumen', [
            'fechaDesde' => $this->fechaDesde, 'fechaHasta' => $this->fechaHasta,
        ]));
        $this->showPrintModal = false;
    }
    ...
    public function addItem()
    {
        ...
        $this->dispatch('update-total', total: $this->suma_items);
    }
