...
trait WithEdicionCfe
{
    ...
    public function editarCfe(int $cfeId): void
    {
        ...
        if ($cfe->items->contains(fn($i) => $i->planilla_er_id !== null)) {
            $this->dispatch('swal:toast-error', text: 'No se puede editar este CFE porque uno o más de sus ítems ya integran una planilla.');
            return;
        }
    ...
    public function guardarEdicion(): void
    {
        ...
        try {
            ...
            $this->dispatch('cerrar-modal-editar-cfe');
            $this->cancelarEdicion();

            $this->dispatch('swal:toast-success', text: 'CFE actualizado correctamente.');
