...
class Index extends Component
{
    ...
    {
        $this->dispatch('swal:confirm', title: '¿Eliminar Certificado?', text: 'Esta acción no se puede revertir.', method: 'delete', id: $id, componentId: $this->getId());
    }

    public function delete($id)
    {
        CertificadoResidencia::find($id)->delete();
        $this->dispatch('swal:success', text: 'Certificado eliminado correctamente.');
        $this->refreshData();
    }
