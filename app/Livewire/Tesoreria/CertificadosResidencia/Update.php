...
class Update extends Component
{
    ...
    public function showDeliverModal($id)
    {
        ...
        $this->dispatch('show-modal', id: 'deliverModal');
    }
    ...
    {
        $this->certificado_id = $id;
        $this->dispatch('show-modal', id: 'returnModal');
    }
    ...
    public function deliver()
    {
        ...
        $this->dispatch('hide-modal', id: 'deliverModal');
        $this->dispatch('swal:success', text: 'Certificado entregado correctamente.');
    }
    ...
    public function return()
    {
        ...
        $this->dispatch('pg:eventRefresh-default');
        $this->dispatch('hide-modal', id: 'returnModal');
        $this->dispatch('swal:success', text: 'Certificado devuelto correctamente.');
    }
