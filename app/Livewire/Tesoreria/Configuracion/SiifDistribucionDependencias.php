...
class SiifDistribucionDependencias extends Component
{
    ...
    {
        $this->resetInput();
        $this->dispatch('show-modal', id: 'siifDependenciaModal');
    }
    ...
    public function store()
    {
        ...
        $this->resetInput();
        $this->dispatch('siifDependenciaStore');
        $this->dispatch('alert', type: 'success', message: 'Dependencia de distribución SIIF creada con éxito.', toast: true);
    }
    ...
    public function update()
    {
        ...
        if ($this->siif_distribucion_dependencia_id) {
            ...
            $this->resetInput();
            $this->dispatch('siifDependenciaUpdate');
            $this->dispatch('alert', type: 'success', message: 'Dependencia de distribución SIIF actualizada con éxito.', toast: true);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $this->dispatch('alert', type: 'success', message: 'Dependencia de distribución SIIF eliminada con éxito.', toast: true);
    }
