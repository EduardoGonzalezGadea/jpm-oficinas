...
class ERDefiniciones extends Component
{
    ...
    public function create()
    {
        ...
        $this->dispatch('openModal', id: 'modalERDefinicion');
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $this->dispatch('closeModal', id: 'modalERDefinicion');
            $this->dispatch('swal', icon: 'success', title: 'Éxito', text: $this->er_definicion_id ? 'Definición actualizada.' : 'Definición creada.');
            $this->resetInputFields();
        } catch (\Exception $e) {
            DB::rollBack();
            $this->dispatch('swal', icon: 'error', title: 'Error', text: 'Ocurrió un error al guardar: ' . $e->getMessage());
        }
    }

    public function confirmDelete($id)
    {
        $this->dispatch('swal-confirm', icon: 'warning', title: '¿Estás seguro?', text: 'Se eliminará esta definición de ER.', id: $id, method: 'delete');
    }
    ...
    public function delete($id)
    {
        ...
        $this->dispatch('swal', icon: 'success', title: 'Eliminado', text: 'La definición ha sido eliminada.');
    }
