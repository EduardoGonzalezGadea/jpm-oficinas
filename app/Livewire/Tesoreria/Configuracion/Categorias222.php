...
class Categorias222 extends Component
{
    ...
    public function create()
    {
        ...
        $this->dispatch('show-modal', id: 'modalCategoria');
    }
    ...
    public function store()
    {
        ...
        $this->dispatch('hide-modal', id: 'modalCategoria');
        $this->dispatch('swal', icon: 'success', title: 'Éxito', text: 'Categoría guardada correctamente.');
        $this->resetForm();
    }

    public function confirmDelete(int $id)
    {
        $this->dispatch('confirm-delete', id: $id, event: 'deleteCategoria', title: '¿Eliminar categoría?', text: 'Solo se marcará como borrada lógicamente.');
    }
    ...
    public function deleteCategoria($id)
    {
        ...
        $this->dispatch('swal', icon: 'success', title: 'Eliminado', text: 'La categoría ha sido eliminada lógicamente.');
    }
}
