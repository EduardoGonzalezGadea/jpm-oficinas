...
class Instituciones222 extends Component
{
    ...
    {
        $this->resetForm();
        $this->dispatch('show-modal', id: 'modalInstitucion');
    }
    ...
    public function store()
    {
        ...
        $this->dispatch('hide-modal', id: 'modalInstitucion');
        $this->dispatch('swal', icon: 'success', title: 'Éxito', text: 'Institución guardada correctamente.');
        $this->resetForm();
    }

    public function confirmDelete(int $id)
    {
        $this->dispatch('confirm-delete', id: $id, event: 'deleteInstitucion', title: '¿Eliminar institución?', text: 'No podrás revertir esto. Los movimientos en caja no se verán afectados porque usamos soft-deletes.');
    }
    ...
    public function deleteInstitucion($id)
    {
        ...
        $this->dispatch('swal', icon: 'success', title: 'Eliminado', text: 'La institución ha sido eliminada lógicamente.');
    }
}
