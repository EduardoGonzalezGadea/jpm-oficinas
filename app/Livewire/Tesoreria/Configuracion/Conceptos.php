...
class Conceptos extends Component
{
    ...
    {
        $this->resetForm();
        $this->dispatch('show-modal', id: 'modalConcepto');
    }
    ...
    public function store()
    {
        ...
        $this->dispatch('hide-modal', id: 'modalConcepto');
        $this->dispatch('swal', icon: 'success', title: 'Éxito', text: 'Concepto guardado correctamente.');
        $this->resetForm();
    }

    public function confirmDelete(int $id)
    {
        $this->dispatch('confirm-delete', id: $id, event: 'deleteConcepto', title: '¿Eliminar concepto?', text: 'Se realizará una eliminación lógica (soft-delete).');
    }
    ...
    public function deleteConcepto($id)
    {
        ...
        $this->dispatch('swal', icon: 'success', title: 'Eliminado', text: 'El concepto ha sido eliminado.');
    }
}
