...
class CajaConceptos extends Component
{
    ...
    public function store()
    {
        ...
        $this->resetInput();
        $this->dispatch('cajaConceptoStore');
        $this->dispatch('alert', type: 'success', message: 'Concepto de caja creado con éxito.', toast: true);
    }
    ...
    public function update()
    {
        ...
        if ($this->caja_concepto_id) {
            ...
            $this->resetInput();
            $this->dispatch('cajaConceptoUpdate');
            $this->dispatch('alert', type: 'success', message: 'Concepto de caja actualizado con éxito.', toast: true);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $this->dispatch('alert', type: 'success', message: 'Concepto de caja eliminado con éxito.', toast: true);
    }
