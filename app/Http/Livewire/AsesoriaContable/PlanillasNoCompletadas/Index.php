...
namespace App\Http\Livewire\AsesoriaContable\PlanillasNoCompletadas;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.asesoria-contable.planillas-no-completadas', compact('planillas', 'anosRegistrados', 'totalesAjustados', 'grupos'))
            ->extends('layouts.app')
            ->section('content');
    }
